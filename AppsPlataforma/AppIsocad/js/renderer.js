/**
 * js/renderer.js
 * Responsable de la representación gráfica sincronizada con la cámara
 */
...
window.CADRenderer = {
    ...
    dibujarGrid: function() {
        ...
        grid.innerHTML = '';
        const tamano = 15; // Metros de extensión
        let d = "";
    ...
    dibujarTuberia: function(el) {
        ...
        if (window.AppCore.seleccion.includes(el.id)) {
            ...
            line.setAttribute("stroke-width", (el.props.grosor || 2) + 2);
        }
    ...
    dibujarEquipo: function(el) {
        // Implementación pendiente para iconos P&ID orientados
    }
};
